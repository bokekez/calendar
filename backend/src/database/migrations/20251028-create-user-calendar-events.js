...
module.exports = {
  async up (queryInterface, Sequelize) {
    ...
    await queryInterface.addIndex('user_calendar_events', ['userId', 'startDateTime'], { name: 'idx_user_start' });
  },

  async down (queryInterface) {
    await queryInterface.removeIndex('user_calendar_events', 'idx_user_start');
    await queryInterface.removeConstraint('user_calendar_events', 'uq_user_google_event');
